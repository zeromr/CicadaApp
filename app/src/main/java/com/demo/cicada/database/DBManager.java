...
import static com.demo.cicada.database.DatabaseHelper.ID_COLUMN;
import static com.demo.cicada.database.DatabaseHelper.MUSIC_ID_COLUMN;
...
public class DBManager {
    ...
    public List<MusicInfo> getMusicListByPlaylist(int playlistId){
        ...
        db.beginTransaction();
        try{
            String sql = "select * from "+ DatabaseHelper.PLAY_LISY_MUSIC_TABLE+" where "+ ID_COLUMN+" = ? ORDER BY " +
